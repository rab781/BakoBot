...
- [x] Test manual ulang `/cek` setelah fix scraper AJAX.
- [x] Validasi scraping nyata untuk `jemberkab` berhasil: 67 record.
- [x] Validasi scraping nyata untuk beberapa daerah lain di Siskaperbapo.
...
- [x] Siapkan deployment 24/7 (via Systemd di Ubuntu).
